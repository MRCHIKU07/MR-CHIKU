...
bot = telebot.TeleBot('7260412570:AAHfGkRnPbBT7i8sVDKO-_gG8yn_nIU_Dxk')
...
def welcome_start(message):
    ...
    response = f'''❄️𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓𝐨 𝐏𝐫𝐞𝐦𝐢𝐮𝐦 𝐃𝐎𝐃𝐎𝐒 𝐁𝐨𝐭, {user_name}! 𝐓𝐡𝐢𝐬 𝐈𝐬 𝐇𝐢𝐠𝐡 𝐐𝐮𝐚𝐥𝐢𝐭𝐲 𝐒𝐞𝐫𝐯𝐞𝐫 𝐁𝐚𝐬𝐞𝐝 𝐃𝐃𝐎𝐒. 𝐓𝐎 𝐆𝐄𝐓 𝐀𝐂𝐂𝐄𝐒𝐒.
